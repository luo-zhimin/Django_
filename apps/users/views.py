...
class UserChangeImageView(View):
    def post(self, request):
...
class UserChangeEmailView(View):
    def post(self, request):
...
class UserLoveTeacherView(View):
    def get(self, request):
