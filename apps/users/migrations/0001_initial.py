    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='https://www.baidu.com', verbose_name='图片链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.IntegerField(choices=[(1, 'register'), (2, 'forget'), (3, 'change')], default=1, verbose_name='验证码类型')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '邮箱验证码',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='用户名称')),
                ('birthday', models.DateTimeField(blank=True, null=True, verbose_name='用户生日')),
                ('gender', models.CharField(choices=[('girl', '女'), ('boy', '男')], default='gril', max_length=10, verbose_name='用户性别')),
