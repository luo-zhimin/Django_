    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('gj', '高级'), ('zj', '中级'), ('cj', '初级')], default='cj', max_length=3, verbose_name='难度')),
                ...
                ('category', models.CharField(choices=[('qd', '前端开发'), ('hd', '后端开发')], default='hd', max_length=20, verbose_name='课程类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('chapter_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.chapterinfo', verbose_name='所属章节')),
            ],
            options={
                'verbose_name': '视频信息',
