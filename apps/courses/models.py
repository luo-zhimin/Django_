...
class CourseInfo(models.Model):
    ...
    level = models.CharField(choices=(('gj', '高级'), ('zj', '中级'), ('cj', '初级')), default='cj', max_length=3,
                             verbose_name='难度')
    ...
    teacher_tell = models.CharField(max_length=200, verbose_name='老师告诉')
    org_info = models.ForeignKey(OrgInfo, verbose_name='所属机构', on_delete=0)
    teacher_info = models.ForeignKey(TeacherInfo, verbose_name='所属讲师', on_delete=0)
...
class ChapterInfo(models.Model):
    ...
    course_info = models.ForeignKey(CourseInfo, verbose_name='所属课程', on_delete=0)
    add_time = models.DateTimeField(datetime.now, verbose_name='添加时间')
...
class VideoInfo(models.Model):
    ...
    url = models.URLField(default='https://www.baidu.com', verbose_name='视频链接', max_length=200)
    chapter_info = models.ForeignKey(ChapterInfo, verbose_name='所属章节', on_delete=0)
    add_time = models.DateTimeField(datetime.now, verbose_name='添加时间')
